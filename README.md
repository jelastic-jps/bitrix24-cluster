...
While the [JPS](https://www.virtuozzo.com/application-platform-docs/jps/) installation the following topology will be created:
...
Where:
 ...
 - The Bitrix24 application itself is handled by either [LiteSpeed Web Server](https://www.virtuozzo.com/application-platform-docs/litespeed-web-server/) or [NGINX PHP](https://www.virtuozzo.com/application-platform-docs/nginx-php/) servers with preconfigured automatic horizontal scaling to handle load spikes
 ...
 - Highly-available [MariaDB Galera Cluster](https://www.virtuozzo.com/company/blog/mariadb-galera-cluster-replication/) is used to store and operate user data. Cluster implements Galera replication topology with synchronous replication between cluster nodes
